...
const priceTable = {
    "美森正班": {
        "美东0.1.2.3": {
            "华南": [19.0, 17.0, 16.5, 15.5, 14.5],
            "华东": [18.5, 16.5, 16.0, 15.0, 14.0]
        },
        "美中4.5.6.7": {
    ...
    "美森加班": {
        ...
        "美中4.5.6.7": {
            "华南": [17.5, 15.5, 15.0, 14.0, 13.0],
            "华东": [17.0, 15.0, 14.5, 13.5, 12.5]
        },
        "美西8.9": {
            "华南": [16.0, 14.0, 13.5, 12.5, 11.5],
            "华东": [15.5, 13.5, 13.0, 12.0, 11.0]
        },
        "美西96-99": {
            "华南": [17.5, 15.5, 15.0, 14.0, 13.0],
            "华东": [17.0, 15.0, 14.5, 13.5, 12.5]
    ...
    "以星合德": {
        "美东0.1.2.3": {
            "华南": [15.7, 14.7, 13.2, 11.7, 11.2],
            "华东": [15.6, 14.6, 13.1, 11.6, 11.1]
        },
        "美中4.5.6.7": {
            "华南": [14.7, 13.7, 12.2, 10.7, 10.2],
            "华东": [14.6, 13.6, 12.1, 10.6, 10.1]
        },
        "美西8.9": {
            "华南": [13.2, 12.2, 10.7, 9.2, 8.7],
            "华东": [13.1, 12.1, 10.6, 9.1, 8.6]
        },
        "美西96-99": {
            "华南": [14.7, 13.7, 12.2, 10.7, 10.2],
            "华东": [14.6, 13.6, 12.1, 10.6, 10.1]
    ...
    "普船": {
        "美东0.1.2.3": {
            "华南": [14.3, 13.3, 11.8, 10.3, 9.8],
            "华东": [14.3, 13.3, 11.8, 10.3, 9.8]
        },
        "美中4.5.6.7": {
            "华南": [13.3, 12.3, 10.8, 9.3, 8.8],
            "华东": [13.3, 12.3, 10.8, 9.3, 8.8]
        },
        "美西8.9": {
            "华南": [11.8, 10.8, 9.3, 7.8, 7.3],
            "华东": [11.8, 10.8, 9.3, 7.8, 7.3]
        },
        "美西96-99": {
            "华南": [13.3, 12.3, 10.8, 9.3, 8.8],
            "华东": [13.3, 12.3, 10.8, 9.3, 8.8]
    ...
    "空派不带电": {
        "美东0.1.2.3": {
            "华南": [44.0, 42.0, 42.0, 41.0, 39.0],
            "华东": [45.0, 43.0, 43.0, 42.0, 40.0]
        },
        "美中4.5.6.7": {
            "华南": [43.0, 41.0, 41.0, 40.0, 38.0],
            "华东": [44.0, 42.0, 42.0, 41.0, 39.0]
        },
        "美西8.9": {
            "华南": [42.0, 40.0, 40.0, 39.0, 37.0],
            "华东": [43.0, 41.0, 41.0, 40.0, 38.0]
        },
        "美西96-99": {
            "华南": [44.0, 42.0, 42.0, 41.0, 39.0],
            "华东": [45.0, 43.0, 43.0, 42.0, 40.0]
    ...
    "空派带电": {
        "美东0.1.2.3": {
            "华南": [46.0, 44.0, 44.0, 43.0, 41.0],
            "华东": [47.0, 45.0, 45.0, 44.0, 42.0]
        },
        "美中4.5.6.7": {
            "华南": [45.0, 43.0, 43.0, 42.0, 40.0],
            "华东": [46.0, 44.0, 44.0, 43.0, 41.0]
        },
        "美西8.9": {
            "华南": [44.0, 42.0, 42.0, 41.0, 39.0],
            "华东": [45.0, 43.0, 43.0, 42.0, 40.0]
            ...
            channels: {
                ...
                "美森正班": {
                    ...
                    prices: {
                        ...
                        "华南": {
                            "美东0.1.2.3": [19, 17, 16.5, 15.5, 14.5],
                            "美中4.5.6.7": [18, 16, 15.5, 14.5, 13.5],
                            "美西8.9": [16.5, 14.5, 14, 13, 12],
                            "美西96-99": [18, 16, 15.5, 14.5, 13.5]
                        }
                    }
                },
                "美森加班": {
                ...
                "普船": {
                    ...
                    prices: {
                        "华东": {
                            "美东0.1.2.3": [14.5, 13.5, 12.0, 10.5, 10.0],
                            "美中4.5.6.7": [13.5, 12.5, 11.0, 9.5, 9.0],
                            "美西8.9": [12.0, 11.0, 9.5, 8.0, 7.5],
                            "美西96-99": [13.5, 12.5, 11.0, 9.5, 9.0]
                        },
                        "华南": {
                            "美东0.1.2.3": [14.5, 13.5, 12.0, 10.5, 10.0],
                            "美中4.5.6.7": [13.5, 12.5, 11.0, 9.5, 9.0],
                ...
                "以星合德": {
                    ...
                    "华南": {
                        "美东0.1.2.3": [15.2, 14.2, 12.7, 11.2, 10.7],
                        "美中4.5.6.7": [14.2, 13.2, 11.7, 10.2, 9.7],
                        "美西8.9": [12.7, 11.7, 10.2, 8.7, 8.2],
                        "美西96-99": [14.2, 13.2, 11.7, 10.2, 9.7]
                    }
                },
                "空派不带电": {
        ...
        "华威尔": {
            ...
            channels: {
                ...
                "空派不带电": {
                    ...
                    prices: {
                        "华南": {
                            "美西7.8.9":   [45.0,43.0,41.0,39.0],
                            "美东0.1.2.3.4.5.6":    [47.0,45.0,43.0,41.0]
                        }
                    }
                },
                "空派带电": {
                    ...
                    prices: {
                        "华南": {
                            "美西7.8.9":   [47.0,44.0,41.0,39.0],
                            "美东0.1.2.3.4.5.6":    [52.0,49.0,46.0,43.0]
                        }
                    }
                }
            }
